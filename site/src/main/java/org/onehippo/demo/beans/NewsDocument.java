...
@HippoEssentialsGenerated(internalName = "customsessionpool:newsdocument")
@Node(jcrType="customsessionpool:newsdocument")
public class NewsDocument extends HippoDocument {

    /**
     * The document type of the news document.
     */
    public final static String DOCUMENT_TYPE = "customsessionpool:newsdocument";
    ...
    private final static String AUTHOR = "customsessionpool:author";
    private final static String SOURCE = "customsessionpool:source";
     ...
     * @return the author
     */
    @HippoEssentialsGenerated(internalName = "customsessionpool:author")
     ...
     * @return the source
     */
    @HippoEssentialsGenerated(internalName = "customsessionpool:source")
